...
class UploadedFile {
  constructor({_id=null,filename=null,year=0,month=0,hashedName,paths=[],createdBy=null,createdAt=null,updatedBy=null,updatedAt=null}) {
    this._id = null;
    if (_id!==null) {
      this._id = _id;
    }
...
const getUploadedFiles = async (req, resp) => {
  ...
  query = "MATCH (n:UploadedFile) "+queryParams+" RETURN n "+queryOrder+" SKIP "+skip+" LIMIT "+limit;
