...
*/
  (function () {
    function ba(g) {
      ...
      function z(k) {
        if (k.type != 'readystatechange' || A.readyState == 'complete')
          (k.type == 'load' ? t : A)[B](p + k.type, z, !1),
            !q && (q = !0) && g.call(t, k.type || k);
      }
      var Y = A.addEventListener;
      var q = !1;
      var C = !0;
      var x = Y ? 'addEventListener' : 'attachEvent';
      var B = Y ? 'removeEventListener' : 'detachEvent';
      var p = Y ? '' : 'on';
      if (A.readyState == 'complete') g.call(t, 'lazy');
      else {
    ...
    for (
      ...
      var P = F[q];
      var Z = P.src.match(/^[^?#]*\/run_prettify\.js(\?[^#]*)?(?:#.*)?$/);
      if (Z) {
        B = Z[1] || '';
      ...
      (function () {
        function k(a) {
          ...
          function g(e) {
            ...
            for (h = 1; h < d.length; ++h) d[h] === -1 && (d[h] = ++k);
            for (l = h = 0; h < c; ++h)
              (n = a[h]),
                n === '('
                  ? (++l, d[l] || (a[h] = '(?:'))
        ...
        function C(a, d) {
          function f(a) {
            for (
              ...
              if (typeof w === 'string') l = !1;
                ...
                !(l = w.length >= 5 && w.substring(0, 5) === 'lang-') ||
                  (h && typeof h[1] === 'string') ||
                  ((l = !1), (w = 'src'));
                l || (u[D] = w);
              }
          ...
          (function () {
            for (
              ...
              var q = f[c];
              var u = q[3];
              if (u) for (var e = u.length; --e >= 0; ) b[u.charAt(e)] = q;
              q = q[1];
              u = '' + q;
        ...
        function B(a, d, f) {
          ...
          function g(a) {
            ...
            a = b(a.nextSibling, 0);
            for (var d; (d = a.parentNode) && d.nodeType === 1; ) a = d;
            c.push(a);
          }
          for (
            var k = /(?:^|\s)nocode(?:\s|$)/,
          ...
          try {
            ...
            try {
              for (; b < t; ) {
                ...
                var E = m[b + 1];
                var G;
                if (E.nodeType !== 1 && (G = p.substring(f, w))) {
                  g && (G = G.replace(d, '\r'));
                  E.nodeValue = G;
                  var aa = E.ownerDocument;
                  var v = aa.createElement('span');
                  v.className = c[x + 1];
                  var B = E.parentNode;
                  B.replaceChild(v, E);
                  v.appendChild(E);
        ...
        var Q = /^(DIR|FILE|vector|(de|priority_)?queue|list|stack|(const_)?iterator|(multi)?(set|map)|bitset|u?(int|float)\d*)\b/;
        var T = /\S/;
        var U = x({
          keywords: [
            S,
        ...
        var V = (R.PR = {
          ...
          prettyPrint: (g = g = function (a, d) {
            function f() {
              for (
                ...
                for (var d = p[r], k = h, q = d; (q = q.previousSibling); ) {
                  var m = q.nodeType;
                  var v = (m === 7 || m === 8) && q.nodeValue;
                  if (
                    v
                      ? !/^\??prettify\b/.test(v)
                      : m !== 3 || /\S/.test(q.nodeValue)
                  )
                    break;
                  if (v) {
                    k = {};
            ...
            var r = 0;
            var t = /\blang(?:uage)?-([\w.]+)(?!\S)/;
            var u = /\bprettyprint\b/;
            var e = /\bprettyprinted\b/;
            var x = /pre|xmp/i;
            var z = /^code$/i;
            var w = /^(?:pre|code|xmp)$/i;
            var h = {};
            f();
          }),
        });
